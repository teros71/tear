...
class TestForms(unittest.TestCase):
    ...
    def test_rect(self):
        ...
        p = r.point_at(geom.Point(10.0, 20.0), 50.0)
        self.assertEqual(p.x, 20.0)
        self.assertEqual(p.y, 20.0)
        p = r.point_at(geom.Point(10.0, 20.0), r.length() + 61.0)
    ...
    def test_circle(self):
        ...
        p = c.point_at(geom.Point(10.0, 20.0), math.pi * c.r)
        self.assertEqual(p.x, -10.0)
        self.assertEqual(round(p.y, 4), 20.0)
        p = c.point_at(geom.Point(50.0, 50.0), 0)
    ...
    def test_polygon(self):
        ...
        p = pol.point_at(geom.Point(10.0, 20.0), 50.0)
        self.assertEqual(p.x, 20.0)
        self.assertEqual(p.y, 20.0)
        p = pol.point_at(geom.Point(10.0, 20.0), pol.length() + 61.0)
        self.assertEqual(p.x, 19.0)
        self.assertEqual(p.y, 10.0)
